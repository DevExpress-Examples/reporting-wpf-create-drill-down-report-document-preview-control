...
Namespace dxWPFApp
    ...
    Public Partial Class MainWindow
        ...
        Private Sub Button_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            Dim preview As DocumentPreviewControl = New DocumentPreviewControl()
        ...
        Private Sub preview_DocumentPreviewMouseClick(ByVal d As DependencyObject, ByVal e As DocumentPreviewMouseEventArgs)
            ...
            If currentReport Is Nothing Then Return
        ...
        Private Function GetMasterReport() As XtraReport
            If masterReport Is Nothing Then CreateMasterReport()
            Return masterReport
        End Function
...
'#Region "*****Master Report Initialization*****;"
        ...
        Private Sub CreateMasterReportControls(ByVal report As XtraReport)
            ...
            For Each col As IColumn In categoriesTable.Columns
                If col.Type Is GetType(Byte()) Then Continue For
                ...
                If Equals(col.Name, "CategoryName") Then
        ...
        Private Shared Function GetMasterData() As SqlDataSource
            Dim ds As SqlDataSource = New SqlDataSource(New Access2007ConnectionParameters("..\..\App_Data\nwind.mdb", ""))
...
'#Region "*****Detail Report Initialization*****"
        Private Function GetDetailReport(ByVal categoryName As String, ByVal categoryID As Integer) As XtraReport
            If detailReport Is Nothing Then CreateDetailReport()
        ...
        Private Sub CreateDetailReportParameters(ByVal detailReport As XtraReport)
            Dim categoryNameParameter As Parameter = New Parameter()
            ...
            Dim categoryIDParameter As Parameter = New Parameter()
        ...
        Private Sub CreateDetailReportControls(ByVal report As XtraReport)
            Dim titleLbl As XRLabel = New XRLabel() With {.LocationF = New System.Drawing.PointF(0, 0), .SizeF = New System.Drawing.SizeF(600, 30), .Font = New System.Drawing.Font("Arial", 18F, System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic), .ForeColor = System.Drawing.Color.Red}
            ...
            Dim homeLabel As XRLabel = New XRLabel() With {.LocationF = New System.Drawing.PointF(0, 0), .SizeF = New System.Drawing.SizeF(400, 30), .Text = "Back to categories", .Font = New System.Drawing.Font("Arial", 16F, System.Drawing.FontStyle.Bold Or System.Drawing.FontStyle.Italic Or System.Drawing.FontStyle.Underline), .NavigateUrl = " ", .ForeColor = System.Drawing.Color.Blue}
